...
class SWTFT : public Adafruit_GFX {
 ...
 public:
  ...
  uint8_t  getFontSize();
  int16_t  getNextCursorY();
  uint16_t getColor();
  uint16_t getBGColor();
  void setColor(uint16_t color);
  void setBGColor(uint16_t bgcolor);  
  void SW_fillRoundRect(int16_t, int16_t, uint16_t, uint16_t);
  void SW_drawRoundRect(int16_t, int16_t, uint16_t, uint16_t);
...
#endif
  void drawText( char *, int16_t, int16_t );
